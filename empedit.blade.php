...
<!-- <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"> -->
  ...
  <input type="textaera" class="form-control"  name="address"value="{{$employees->address}}" aria-describedby="emailHelp">
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control"name="mobile"value="{{$employees->mobile}}">
